...
export const Route = createFileRoute("/gallery")({
  head: () => ({
    meta: [
      { title: "সার্টিফিকেট গ্যালারি | 10 Minute School" },
      {
        name: "description",
        content:
          "10 Minute School-এর কৃতি শিক্ষার্থীদের সার্টিফিকেট গ্যালারি দেখো। ক্লাস বা নাম দিয়ে ফিল্টার করো।",
      },
      /* ── Open Graph ── */
      { property: "og:site_name", content: "10 Minute School" },
      { property: "og:locale", content: "bn_BD" },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://ks.10minuteschool.com/gallery" },
      { property: "og:title", content: "সার্টিফিকেট গ্যালারি | 10 Minute School" },
      {
      ...
      { property: "og:image:alt", content: "10 Minute School কৃতি শিক্ষার্থী সার্টিফিকেট গ্যালারি" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      /* ── Twitter / X Card ── */
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@10minuteschool" },
      { name: "twitter:title", content: "সার্টিফিকেট গ্যালারি | 10 Minute School" },
      {
        name: "twitter:description",
        content:
          "10 Minute School-এর কৃতি শিক্ষার্থীদের সার্টিফিকেট গ্যালারি দেখো।",
      },
      { name: "twitter:image", content: "https://ks.10minuteschool.com/og-image.jpg" },
      { name: "twitter:image:alt", content: "10 Minute School কৃতি শিক্ষার্থী সার্টিফিকেট গ্যালারি" },
    ],
  }),
